...
/** Tabler Icons outline `filter`. */
export function FilterIcon({ className = 'size-3.5' }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
/** Tabler Icons outline `filter-off`. */
export function FilterOffIcon({ className = 'size-3.5' }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M8 4h12v2.172a2 2 0 0 1 -.586 1.414l-3.914 3.914m-.5 3.5v2l-6 2v-8.5l-4.48 -4.928a2 2 0 0 1 -.52 -1.345v-2.227" />
      <path d="M3 3l18 18" />
    </svg>
  )
}
